...
public class MetaData {
    ...
    public ClassInfo classInfoNeo4JOSGI(String name, Boolean queryForARealClass) {
        ...
        if (name.contains(".") == false) {
            name = Neo4JOSGI.modelPackagePath + "." + name;
        }

        if (classInfos.containsKey(name)) {
            if (classInfos.get(name)!=null)
    ...
    public ClassInfo resolve(String... taxa) {
        ...
        if (taxa.length > 0) {
            ...
            for (String taxon : taxa) {
                ...
                ClassInfo taxonClassInfo = classInfoMaybeWrongNeo4JOSGI(taxon, true);
    ...
    public String entityType(String name) {
        ...
        if (classInfo==null)
            classInfo = Neo4JOSGI.classInfo(this, name);
